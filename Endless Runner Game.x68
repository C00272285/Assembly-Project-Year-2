...
START: 
*NOTES
*FOR THIS VERSION, THE POINTS ARE NOT WORKING AAS INTENDED, THE GROUND LINE SHOULD NOT BE WORKING THE WAY IT CURENTLY IS, PLANNING ON ADDING AN IMMAGE TO MAKE THE PLAYER. 


*TRYING TO GET THE HOMESCREEN TO WORK PROPERLY
    ;HomeSCREEN:
    ;LEA     MAINMENU,A1
    ;MOVE.B #13,D0
    ;MOVE.B  (A1),D1
 ...
 *SETTING UP THE SCREEN SIZE
    ...
    *SETTING UP THE POSITION FOR THE SECOND ENEMY
    ...
    MOVE.L  D1,         ENEMY_TWO_Y     ; Enemy Y Position
...
UPDATE
    ...
    ; MOVE ENEMY TWO
    CLR.L   D1                      ; Clear contents of D1 (XOR is faster)
    MOVE.L  ENEMY_TWO_X,    D1          ; Move the Enemy X Position to D0
    CMP.L   #01,        D1
